...
class BuildfarmReleaseSourceBuildTask(TaskExtensionPoint):
    """Build ROS buildfarm release source package jobs."""
    ...
    async def release(self):  # noqa: D102
        ...
        subdir = '.'.join((args.build_name, args.os_name, args.os_code_name))
        ...
        generation_cmd = [
            ...
            args.os_name, args.os_code_name, '', '--skip-binary',
        ]
        ...
        await extension.import_source(
            args, args.os_name, args.os_code_name,
            staging_dir / 'source')
